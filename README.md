# AiNova Documentation

This repository contains the AiNova VitePress documentation site. The
...
The staged production files are generated in `projects/AiNova/en/latest/`.
...
```text
https://hiwonder-docs.github.io/AiNova-vite/projects/AiNova/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/AiNova/en/latest/
```
